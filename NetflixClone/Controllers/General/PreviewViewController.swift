...
extension PreviewViewController {
    private func configureConstraints() {
        ...
        let downloadButtonConstraints =  [
            ...
            downloadButton.bottomAnchor.constraint(lessThanOrEqualTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -10),
    ...
    public func configure(with preview: PreviewYoutube) {
        titleLabel.text = preview.title
        overviewLabel.text = preview.titleOverview
